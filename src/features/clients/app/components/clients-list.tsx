...
export function ClientsList() {
  ...
  return (
    <div className="divide-border rounded-xl border">
      <div className="text-muted-foreground grid grid-cols-2 gap-2 border-b px-4 py-2 text-xs font-medium md:grid-cols-4">
      ...
      <ul className="divide-y">
        {rows.map((c) => (
          <li key={c.id} className="grid grid-cols-2 gap-2 px-4 py-3 text-sm md:grid-cols-4">
