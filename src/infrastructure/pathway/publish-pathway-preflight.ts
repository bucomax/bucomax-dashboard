...
import { assertStageDefaultAssigneesInTenant } from "@/application/use-cases/shared/validate-tenant-members";
 ...
 * Não grava no banco.
 */
export async function runPathwayPublishPreflight(params: {
  tenantId: string;
  pathwayId: string;
  versionId: string;
  graphJson: unknown;
