  ...
  for (const clientSeed of seed.clients) {
    ...
    const client = await prisma.client.create({
      data: {
        ...
        documentId: clientSeed.documentId ?? null,
        postalCode: clientSeed.postalCode ?? null,
        addressLine: clientSeed.addressLine ?? null,
        addressNumber: clientSeed.addressNumber ?? null,
        addressComp: clientSeed.addressComp ?? null,
        neighborhood: clientSeed.neighborhood ?? null,
        city: clientSeed.city ?? null,
        state: clientSeed.state ?? null,
        isMinor: clientSeed.isMinor ?? false,
        guardianName: clientSeed.guardianName ?? null,
        guardianDocumentId: clientSeed.guardianDocumentId ?? null,
        guardianPhone: clientSeed.guardianPhone ?? null,
